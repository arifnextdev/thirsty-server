...
userSchema.statics.register = async function (name, email, password, photoURl, phoneNumber, address) {
    ...
    if (validator_1.default.isStrongPassword(password)) {
        throw new Error('Password must 8+ chars, containes uppercase, lowercase, and special chars');
    }
